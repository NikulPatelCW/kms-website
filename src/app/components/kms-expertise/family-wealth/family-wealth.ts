...
export class FamilyWealth {
  ...
  sections = {
    ...
    note: 'Family Governance | Family Enterprise Solutions | Family Trusts & Holding Structures | Liability / Obligation Management | Wealth Optimisation',
