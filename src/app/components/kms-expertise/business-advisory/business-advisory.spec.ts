...
describe('BusinessAdvisory', () => {
  ...
  it('should initialize header properties', () => {
    expect(component.headerBg).toBe('assets/images/expertise/business.jpg');
  ...
  it('should have sections with correct structure', () => {
    ...
    expect(component.sections.image).toBe('assets/images/expertise/business-advisory-img.jpg');
